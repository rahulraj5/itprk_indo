...
class Home extends CI_Controller {
	...
	{
		parent::__construct();
		$this->SessionModel->checkuserlogin(array("sendsmsdemo","faqs","cancellation_policy","selling_fees","vendor_registration","user_agreement","seller_agreement","sell_on_indocliq","login","loginajax","registerajax","index","registration_otp_send","confirmregisterajax","loginbypassword","createCode","shops","shopdetail","productdetail","variant_price","buynow","addToCart","contact","updateNavCart","cart","removeCartProduct","updateQuantity","addshippinginfo","uploadfilebypath","contactinfo","aboutus","privacy_policy","terms_condition","products","clearance_product","forgotpasswordsubmit","verifyForgotOtp","changeforgotpasswrodsubmit","loginbyotpsubmit","verifyloginOtp","clearance_detail","subcatbycatname"));
	}
    ...
    public function selling_fees(){
        $this->load->view('front/header1');
        $this->load->view('front/selling_fees');
    ...
    public function vendor_registration(){
        ...
        // 			$data['zipcode'] = $_POST['display_name'];
        			$data['email'] = $_POST['email'];
        			
        // 			$data['name'] = $_POST['password2'];
        ...
        // 			die;
        			...
        			if($result){
        					...
        					$this->session->set_flashdata('regiter_success', 'Registration has been sucessfully');
        ...
        // 			$data['SUCCESS'] = "Added successfully";
    	       ...
    	       $this->session->set_flashdata('regitered_error', 'You have already registered from this mobile number.');
    		}   
        }	
...
//         }
    ...
    {
    	$data = array();
		$seller_data = $this->Common_model->getSingleData('faqs_data',array('id' =>2));
		$data['seller_data'] = $seller_data;
    	$this->load->view('front/header');
