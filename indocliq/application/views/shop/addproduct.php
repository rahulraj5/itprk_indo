                   ...
                   <!--         <?php } ?>-->
						...
						<div class="col-md-12">
                            ...
                            <div class="col-md-12" style="padding: 0px">
                                <input type="file" name="main_image" id="file-2" class="custom-input-file custom-input-file--4" data-multiple-caption="{count} files selected" accept="image/*">
