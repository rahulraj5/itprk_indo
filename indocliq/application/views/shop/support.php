...
<div class="container-fluid pt-10 bgp">
    <div class="row content m-10" style="padding: 0px";>
      
      <div class="col-sm-12 col-lg-12">
        <div>
          <div class="col-md-12">
            <h3><img src="<?php echo base_url().'common_assets/images/user.png';?>" style="width: 30px">Ticket ID: <?php echo $id?> &nbsp&nbsp&nbsp Status: <?php if($support['status']==0){echo 'Close';}
                  if($support['status']==1){echo 'Open';}?>
            &nbsp&nbsp&nbsp Create Date: <?php echo $support['create_date']; ?> &nbsp&nbsp&nbsp Close Date: <?php echo $support['close_date']; ?></h3>
          </div>
          <div class="col-md-12">
            <h3>&nbsp&nbsp&nbsp&nbsp Query: <?php echo $support['query']; ?></h3>
          </div> 
...
<script>
  $( "#support_chat_form" ).submit(function( event ) {
    ...
    type: "POST",
    dataType: "html",
    url: "<?php echo base_url()?>shop/submitmessage",
    data:data,
  ...
  function support_chat_message(ticket_id){
    ...
    url: "<?php echo base_url()?>shop/support_chat_message",
    dataType: "html",
    success : function(data){
      // alert(data);
      // $.notify(data, "success");
