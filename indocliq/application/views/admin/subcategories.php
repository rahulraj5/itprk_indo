...
<div class="content-wrapper">
  ...
  <section class="content-header"><h1><img src="<?php echo base_url().'common_assets/images/categories.png';?>"> Sub Categories<small>List</small></h1></section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>admin/addsubcategory" class="btn btn-primary pull-right">Add New Sub Category</a>
            </h3>
          </div>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo base_url() ?>admin/addsubcategory/<?php echo  $getdata['categories_id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
