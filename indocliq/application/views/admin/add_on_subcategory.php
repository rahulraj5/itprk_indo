              ...
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="parent_category_id" required>
                      ...
                      ?>
                          <option value="<?php echo $pgetdata['categories_id']; ?>" <?php echo (isset($cat_data['parent_sub_category_id']) && $cat_data['parent_sub_category_id'] == $pgetdata['categories_id'] ? 'selected' : ''); ?> ><?php echo (isset($pgetdata['category_name']) ? $pgetdata['category_name'] : ''); ?></option>
                    <?php } } ?>
                    </select>
                  </div>
                  <div class="form-group">
                    <label>Sub-Subcategories Name</label>
