...
<div class="content-wrapper">
  ...
  <section class="content-header"><h1>Testimonial <small>List</small></h1></section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>admin/add_testimonial" class="btn btn-primary pull-right">Add New </a>
            </h3>
          </div>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php  echo (!empty($getdata['description'])?$getdata['description']:'none'); ?></td>
                     ...
                     <!--  <td>
                      ...
                      <td>
                        &nbsp;
                        <a href="<?php echo base_url() ?>admin/add_testimonial/<?php echo $getdata['id']; ?>" title="Edit"><i class="fa   fa-pencil-square-o" aria-hidden="true"></i></a> 
                        &nbsp; 
                       <!--  &nbsp;
                        <a href="<?php echo base_url() ?>admin/add_testimonial/<?php echo $getdata['id']; ?>" title="Edit Brand"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                        &nbsp; -->
                        <!-- <?php if($ul['status'] == 1){ ?>
