  ...
  <div class="content-wrapper">
    ...
    <?php if($banner_data) { 
      ...
      <ol class="breadcrumb">
        ...
        <li class=""><a href="<?php echo base_url()?>admin/homebannerslidersec">Homeslider Banners</a></li>
        ...
        <div class="box-body">
          ...
          <form role="form" enctype="multipart/form-data" method="post" action="">
              <div class="col-md-6">
                  ...
                  ?>
                    <div class="form-group">
                      <img src="<?php echo base_url()?>uploads/homebannerslidersec/<?php echo (!empty($banner_data['image']) ? $banner_data['image'] : "default.png")?>">
                    </div>
