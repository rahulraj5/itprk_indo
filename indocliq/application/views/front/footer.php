					...
					<div class="row pt-20 maintag">
						<div class="col-lg-2">
							<div class="footer-main f">
								...
								<ul>
									...
									<li><a href="<?php echo base_url(); ?>cancellation-policy">Cancellation & Return</a></li>
						...
						<div class="col-lg-3">
							<div class="footer-main3 f">	
								...
								<img style="height: 29px; margin-right: 10px;" src="front_assets/images/sslsecure.png">
							</div>
						</div>
					</div>		
				</div>				
		...
		<section class="copyright">
			<div class="container">
				<div class="row bottom-s text-center">
							<div class="col-lg-6 cotag"><p>© Copyright 2020. All Rights Reserved. by <a href="#"> Flyingfoxtradecom pvt. ltd.</a></p>
							</div>
							<div class="col-lg-6 paytag" style="text-align:revert;"><h5>Payment Options</h5>
								<img style="height: 22px;"  src="front_assets/images/visa.jpg">
								<img style="height: 22px;"  src="front_assets/images/mastercart.jpg">
								<img style="height: 22px;"  src="front_assets/images/paytm.jpg">
								<img style="height: 22px;" src="front_assets/images/rupay.png">
								<img style="height: 22px;" src="front_assets/images/upi.jpg">
							</div>
				</div>
			</div>
		</section>
