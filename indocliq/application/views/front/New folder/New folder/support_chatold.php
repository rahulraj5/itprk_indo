...
<div class="container-fluid pt-10 bgp">
    <div class="row content m-10">
      ...
      <div class="col-sm-12 col-lg-9">
        <h3><img src="<?php echo base_url().'common_assets/images/user.png';?>" style="width: 30px">Ticket ID: <?php echo $id?> &nbsp&nbsp &nbsp Query: &nbsp &nbsp Status: &nbsp &nbsp Create Date: &nbsp &nbsp Close Date: </h3>
