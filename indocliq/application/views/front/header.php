				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-2 col-md-2 col-xs-2 pt-1">
						...
						<div id="mySidebar" class="sidebar">
							...
							<a href="<?php echo base_url(); ?>faqs"><i class="fa fa-file"></i>FAQs</a>
								...
								<div class="input-group">
					                ...
					                <div class="input-group-btn search-panel">
					                    ...
					                    <ul class="dropdown-menu dropm" role="menu">
					                      ...
					                      <li><a href="#<?php echo $allcategoriesdatasec['category_name']?>"><?php echo $allcategoriesdatasec['category_name']?></a></li>
					                ...
					                <input type="hidden" name="categories_id" value="all" id="search_param">         

					                <input type="text" class="form-control fc-1" name="x" placeholder="Search">

					                <span class="input-group-btn">

					                    <button class="btn btn-default searchbb" type="submit"><i class="fa fa-search"></i></button>
						...
						<div class="login-btn orderrturn">
								...
								<i class="fa fa-search search_show"></i>
									...
									<?php if(isset($session_userdata) && !empty($session_userdata)){ ?>
									    ...
									    <span class="responsive_none"><i class="fa fa-sign-in"></i> Sign in</span>
						...
						<div class="login-btn">
								...
								<i class="fa fa-search search_show"></i>
									...
									?>
									    ...
									    <span class="responsive_none"> Orders</span>
									    ...
									    <span class="responsive_none">Orders</h6></span>
