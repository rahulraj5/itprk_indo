...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-2 col-md-2 col-xs-2 pt-1">
						...
						<div id="mySidebar" class="sidebar">
							...
							<!--<a href="<?php echo base_url(); ?>vendor_registration"> <i class="fa fa-user-plus"></i>Registration</a>-->
 ...
 <!--<a href="<?php echo base_url(); ?>vendor_registration" target="" id="subscribe_youtube" class="">-->
