...
<body>
	...
	<header class="header" style="position: sticky; top: 0; left: 0;z-index: 10000; height: 100%; width: 100%;">
		...
		<div class="header-top">
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-2 col-md-2 col-xs-2 pt-1">
						...
						<div id="mySidebar" class="sidebar">
							...
							<a href="<?php echo base_url(); ?>shop"> <i class="fa fa-sign-in"></i>Login</a>

							<a href="http://indocliq.com/vendor_registration"> <i class="fa fa-user-plus"></i>Registration</a>
							...
							<a href="<?php echo base_url(); ?>selling_fees"><i class="fa fa-file"></i>Fee and Pricing</a>
						...
						<div class="login-btn orderrturn">
								...
								<i class="fa fa-search search_show"></i>
								  ...
								  <!--  	</a>-->
										...
										<a type="button" href="<?php echo base_url()?>shop" class="sign_in" href-btntype="signin">

									    <span class="responsive_none">Login </span>
										...
										<a type="button" href="<?php echo base_url()?>vendor_registration" class="sign_in" href-btntype="signin">

									    <span class="responsive_none">Signup </span>
				...
				// 			echo (isset($spdata) && !empty($spdata) ? count($spdata) : 0); 
 ...
 <a href="http://indocliq.com/vendor_registration" target="" id="subscribe_youtube" class="">

      <img class="img-responsive you" src="<?php echo base_url();?>front_assets/images/register_img.png" alt="subscribe" title="Register Now">
