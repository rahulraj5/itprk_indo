$(document).ready(function() { 
            ...
            success : function(data){
                if (data.status == 1){
                    ...
                    if(clickbutton == "buynw"){
                        ...
                        // setTimeout(function(){window.location.href=base_url+"shops"},1000);
    ...
    $(".couoncodeapply").on("click", function(){
        // alert("hi");
        $(".couoncodeapply").attr('disabled', true);
        $(".couoncodeapply").addClass('buttonload'); 
        $(".couoncodeapply").html('<i class="fa fa-spinner fa-spin"></i>Loading');
        // Initiate Variables With Form Content
        var couponcode = $("#couponcode").val();
        // alert(couponcode);
        var href = base_url+"home/couoncodeapply";
        $.ajax({
            type: "POST",
            dataType: "json",
            url: href,
            ...
            success : function(data){
                if(data.status == 1){
                    ...
                    setTimeout(function(){window.location.href=current_page_url},1000);
                    updateNavCart();
                    $(".couoncodeapply").removeAttr('disabled');
                    $(".couoncodeapply").removeClass('buttonload');
                    $(".couoncodeapply").html('Apply');
    ...
    $(".removecouponcode").on("click", function(){
        // alert("hi");
        $(".removecouponcode").attr('disabled', true);
        $(".removecouponcode").addClass('buttonload'); 
        $(".removecouponcode").html('<i class="fa fa-spinner fa-spin"></i>Loading');
        // Initiate Variables With Form Content
        var couponcode = $("#couponcode").val();
        // alert(couponcode);
        var href = base_url+"home/removecouponcode";
        $.ajax({
            type: "POST",
            dataType: "json",
            url: href,
            ...
            success : function(data){
                if(data.status == 1){
                    ...
                    updateNavCart();
                    setTimeout(function(){window.location.href=current_page_url},1000);
                    $(".removecouponcode").removeAttr('disabled');
                    $(".removecouponcode").removeClass('buttonload');
                    $(".removecouponcode").html('Apply');
    ...
    $("#support_message").on("click", function(){
      ...
      $("#support_message_form #support_message").html('<i class="fa fa-spinner fa-spin"></i>Loading');
        ...
        // alert(form);
        var href = base_url+"support_ticket";
