$(function() {
	...
	$( ".prateButton" ).click(function() {
		if($(this).hasClass('btn-grey')) {			
			$(this).removeClass('btn-grey btn-default').addClass('btn-warning pstar-selected');
			$(this).prevAll('.prateButton').removeClass('btn-grey btn-default').addClass('btn-warning pstar-selected');
			$(this).nextAll('.prateButton').removeClass('btn-warning pstar-selected').addClass('btn-grey btn-default');			
		} else {						
			$(this).nextAll('.prateButton').removeClass('btn-warning pstar-selected').addClass('btn-grey btn-default');
		}
		$(".prating").val($('.pstar-selected').length);	
	});
