			...
			<div class="col-lg-2 l_s">
				...
				<div class="catogaries1">
				    ...
				    // 		print_r($allcategoriesc);
                        ...
                        ?>
                        		<li class="nav-item">
								    <a href="<?php echo base_url(); ?>clearance_detail?shop_id=<?php echo $shop_id; ?>&categories_id=<?php echo $allcategoriesdata['categories_id']; ?>" class="nav-link  <?php echo (isset($_GET['categories_id']) && $_GET['categories_id'] == $allcategoriesdata['parent_category_id'] ? 'active' : ''); ?>"  >
								      	<div class="icon-img">
