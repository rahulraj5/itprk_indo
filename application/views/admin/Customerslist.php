<div class="content-wrapper">
  <section class="content-header">
    <h1> <img src="<?php echo base_url().'common_assets/images/user.png';?>" style="width: 30px">Customers<small></small></h1>
  </section>
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header col-md-6" style="float: left;">
          <h3 class="box-title"><a href="<?php echo base_url();?>admin/AddCustomer" class="btn btn-primary">Add Customer</a></h3>
        </div>
          ...
          <table id="customertable" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="<?php echo base_url() ?>admin/AddCustomer/<?php echo  $getdata['id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
