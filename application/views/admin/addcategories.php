          ...
          <form role="form" enctype="multipart/form-data" method="post" action="">
              <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="category_percentage" value="<?php echo (!empty($cat_data) && !empty($cat_data['category_percentage']) ? $cat_data['category_percentage'] : "" )?>">
                  </div>
                  <?php 
                  if(!empty($cat_data))
                  {
