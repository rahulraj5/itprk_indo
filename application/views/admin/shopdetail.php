            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <li class="list-group-item">
                  ...
                  <b>GST NO.</b> <a class="pull-right"><?php echo (!empty($shop_data) && !empty($shop_data['gst_number']) ? $shop_data['gst_number'] : "" );?></a>

                </li>

                <!-- <li class="list-group-item">

                  <b>Categories</b> <a class="pull-right"><?php echo (isset($shop_data['shopping_categories']) ? $shop_data['shopping_categories'] : '')?></a>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                ...
                <i class="fa fa-phone margin-r-5"></i>  <b>State</b> <a class="pull-right"><?php echo (isset($shop_data['state_name']) ? $shop_data['state_name'] : '')?></a>

              </p>
              <p class="text-muted">

                <i class="fa fa-phone margin-r-5"></i>  <b>City</b> <a class="pull-right"><?php echo (isset($shop_data['city_name']) ? $shop_data['city_name'] : '')?></a>

              </p>
              <p class="text-muted">

                <i class="fa fa-phone margin-r-5"></i>  <b>Zipcode</b> <a class="pull-right"><?php echo (isset($shop_data['shop_pincode']) ? $shop_data['shop_pincode'] : '')?></a>
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="active tab-pane" id="activity">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <b>Categories</b> <p class="pull-right"><?php echo (isset($shop_data['shopping_categories']) ? $shop_data['shopping_categories'] : '')?></p>
                  </div>
