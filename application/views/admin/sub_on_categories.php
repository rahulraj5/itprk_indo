...
<div class="content-wrapper">
  ...
  <section class="content-header"><h1><img src="<?php echo base_url().'common_assets/images/categories.png';?>"> Sub-Subcategories<small>List</small></h1></section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>admin/add_on_subcategory" class="btn btn-primary pull-right">Add New Sub-Subcategory</a>
            </h3>
          </div>
                ...
                <?php $count = 1; 
                  ...
                  ?>
                    <tr>
                      ...
                      <!-- <td><?php  echo (!empty($getdata['category_sub_name'])?$getdata['category_sub_name']:'none'); ?></td> -->
                      ...
                      <td>
                        <a href="<?php echo base_url() ?>admin/add_on_subcategory/<?php echo  $getdata['categories_id']; ?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
