        ...
        <div class="box">
          <div class="box-body">
            <div class="table-responsive">
              <h3 class="box-title" style="padding-bottom: 10px;"><i class="fa fa-question-circle"></i> New Orders</h3>
                <div class="row">
                    <!-- <form >
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo base_url().'shop/invoice?invoice='.base64_encode($ordersarray['id']); ?>">view</a>
                                </li>
