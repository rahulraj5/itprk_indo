...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <?php 
    // print_r($shop_data);
     if (isset($shop_data['shop_id']) && !empty($shop_data['shop_id'])) { ?>

      <h1><img src="<?php echo base_url() . 'common_assets/images/shop.png'; ?>" style="width: 30px"> Edit Profile (<?php echo (isset($shop_data['shop_reg_id']) ? $shop_data['shop_reg_id'] : ''); ?>)</h1>

    <?php } else { ?>

      <h1><img src="<?php echo base_url() . 'common_assets/images/shop.png'; ?>" style="width: 30px"> Edit Profile</h1>
      ...
      <div class="box-body">
        ...
        <div class="row" style="margin: 0px">
          ...
          <div class="nav-tabs-custom">
            ...
            <form role="form" data-parsley-validate enctype="multipart/form-data" method="post" action="" id="form">
                ...
                <div class="active tab-pane" style="margin: 10px" id="activity">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <label>Adhar Number <sup>*</sup></label>
                  ...
                  <div class="col-md-6">
                    ...
                    <?php if (!empty($shop_type_list)) { ?>
                      ...
                      <div class="form-group">
                        ...
                        <label>Select Shop Type <sup>*</sup></label>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2 catselect" name="shopping_categories[]" multiple="multiple" data-placeholder="Select a categories" style="width: 100%;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2 specialsubcat" name="shopping_specialized[]" multiple="multiple" data-placeholder="Select a categories" style="width: 100%;">
                  ...
                  <div class="col-md-12">
                    ...
                    <script src="<?php echo base_url(); ?>common_assets/js/jquery.min.js"></script>
...
<link rel="stylesheet" href="<?php echo base_url() ?>common_assets/css/parsley.css">
<link rel="stylesheet" href="<?php echo base_url() ?>common_assets/css/jquery.timepicker.min.css">
<script src="<?php echo base_url() ?>common_assets/js/jquery.timepicker.min.js"></script>

<!-- Form Validation JS -->
<script src="<?php echo base_url() ?>common_assets/js/parsley.min.js"></script>
