                ...
                <div class="panel-heading fast-view-panel">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge">
                                <div style="font-size: 20px;"><?= date('d.m.Y'); ?></div>
                ...
                <div class="panel-heading fast-view-panel">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            ...
                            <div>Low Quantity Products!</div>
                        </div>
                    </div>
                </div>
                <!--<a href="<?= base_url('shop/products?orderby=quantity=asc') ?>">-->
                <a href="<?= base_url('shop/low_product_list?orderby=quantity=desc') ?>">    
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-green">
                <div class="panel-heading fast-view-panel">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo $this->Common_model->getRecordCount('orders',array('seller_id'=>shopsessionShopid(),'status'=>1,'delivery_status'=>1)); ?></div>
                            <div>Pending Orders</div>
                        </div>
                    </div>
                </div>
                <a href="<?= base_url('shop/neworders') ?>">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-yellow">
                <div class="panel-heading fast-view-panel">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo $this->Common_model->getRecordCount('orders',array('seller_id'=>shopsessionShopid(),'status'=>1,'delivery_status'=>4)); ?></div>
                            <div>Complete Orders!</div>
                        </div>
                    </div>
                </div>
                <a href="<?= base_url('shop/orderhistory') ?>">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
            ...
            <div class="panel panel-red">
                <div class="panel-heading fast-view-panel">
                    <div class="row">
                        ...
                        <div class="col-xs-9 text-right">
                            <div class="huge"><?php echo $this->Common_model->getRecordCount('orders',array('seller_id'=>shopsessionShopid(),'status'=>1,'delivery_status'=>4)); ?></div>
                            <!--<div class="huge"><?php echo $this->Common_model->getRecordCount('orders',array('status'=>1,'delivery_status'=>4));?></div>-->
                            <div>Pending products</div>
                        </div>
                    </div>
                </div>
                <a href="<?= base_url('shop/pending_productlist?status=0') ?>">
                    <div class="panel-footer">
                        <span class="pull-left">View Details</span>
                        <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                        <div class="clearfix"></div>
